...
/**
 * ProgramA simply reads a file containing rows of space-separated Strings, your
 * assignment is to print out those strings interpreted as a graph.
 **
 ** @author Mike Stein
 **/
...
public class Prog340 extends JPanel /* implements ActionListener */ {
	...
	/**
	 * The main method instantiates a Prog340 class, which includes giving you a
	 * choice of things to do. The only one active now will be reading the graph
	 * file and having you parse it.
	 **
	 ** @param args - Not used
	 **
	 ** @throws FileNotFoundException - Thrown if the file selected is not found.
	 *                               Shouldn't happen with a FileChooser.
	 **/
	...
	/**
	 * Create and show the GUI. For thread safety, this method should be invoked
	...
	private static void createAndShowGUI() {
		...
		;
		 // Set preferred size
		 frame.setPreferredSize(new Dimension(800, 600)); // Set your desired width and height
	...
	/**
	 * The constructor creates a new ProgramA object, and sets up the input and
	 * output files.
	 **/
	public Prog340() {
	...
	/**
	 * Read the file containing the Strings, line by line, then process each line as
	 * it is read.
	 **/
